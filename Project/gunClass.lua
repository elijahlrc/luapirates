...
function cannonClass(position,speed,gun_rot,lifetime,reload_time,owner,x_offset,y_offset,sprite,random_rot,random_vel,group,proj_size,cost,mass,name,drag)
